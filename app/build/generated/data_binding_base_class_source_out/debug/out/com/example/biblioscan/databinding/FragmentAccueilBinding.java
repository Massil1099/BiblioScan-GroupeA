...
public final class FragmentAccueilBinding implements ViewBinding {
  ...
  private FragmentAccueilBinding(@NonNull LinearLayout rootView, @NonNull Button openCameraButton) {
  ...
  public static FragmentAccueilBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentAccueilBinding((LinearLayout) rootView, openCameraButton);
    }
